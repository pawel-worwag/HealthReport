...
public partial class Weight(IWeightMeasurementsHandler loadHandler, AuthenticationStateProvider authStateProvider) : ComponentBase
{
	...
	private ICollection<WeightMeasurementDto>? _data = null;
