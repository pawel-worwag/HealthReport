...
public partial class BloodPressure(IBloodPressureMeasurementsHandler loadHandler, AuthenticationStateProvider authStateProvider) : ComponentBase
{
	...
	private ICollection<BloodPressureMeasurementDto>? _data = null;
