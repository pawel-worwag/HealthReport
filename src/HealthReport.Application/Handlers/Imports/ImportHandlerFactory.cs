...
public class ImportHandlerFactory(IServiceProvider provider)
{
    ...
    {
        var handlerType = source switch
        {
            ImportSource.BloodPressureIHealth => typeof(BloodPressureIHealthImportHandler),
            ImportSource.BloodGlucoseContour => typeof(BloodGlucoseContourImportHandler),
            ImportSource.WeightGarmin => typeof(WeightGarminImportHandler),
